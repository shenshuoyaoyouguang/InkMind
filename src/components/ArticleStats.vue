    ...
    <div v-else class="stats-content">
          ...
          <el-row :gutter="16" style="margin-top: 16px">
            <el-col :span="8">
              <div class="analysis-section">
                ...
                <ul>
                  <li
                    v-for="strength in articleStats.aiAnalysis.evaluation
                      ?.strengths || []"
                    :key="strength"
                  >
                    {{ strength }}
            ...
            <el-col :span="8">
              <div class="analysis-section">
                ...
                <ul>
                  <li
                    v-for="weakness in articleStats.aiAnalysis.evaluation
                      ?.weaknesses || []"
                    :key="weakness"
                  >
                    {{ weakness }}
            ...
            <el-col :span="8">
              <div class="analysis-section">
                ...
                <ul>
                  <li
                    v-for="suggestion in articleStats.aiAnalysis.evaluation
                      ?.suggestions || []"
                    :key="suggestion"
                  >
                    {{ suggestion }}
      ...
      <div class="stats-section">
        <h3 class="section-title">
          {{ articleStats.aiAnalysis ? "基础建议" : "写作建议" }}
        </h3>
