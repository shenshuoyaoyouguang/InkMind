  ...
  <div class="template-manager">
        ...
        >
          <div class="template-header">
            <div class="template-title">
              ...
              <el-tag v-if="template.isSystem" type="info" size="small">
                系统
              </el-tag>
    ...
    >
      ...
      >
        ...
        <el-form-item label="目标受众" prop="audience">
          <el-select
            v-model="editingTemplate.audience"
            placeholder="请选择目标受众"
            style="width: 100%"
          >
            <el-option label="青少年" value="teen" />
...
const templates = computed(() => {
  // 合并系统模板和自定义模板
  const systemTemplates = novelStore.templates.map((t) => ({
    ...t,
    isSystem: true,
  }));
